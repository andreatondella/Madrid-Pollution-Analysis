...
At first we build a regression model with all variables available in the data tables in order to understand the impact each one has on the level of NO~2~ recorded.
