...
map_data = subset(daily_data, ob_date == "2011-10-30" & param_Form == "NO2", c("Lng", "Lat", "temp_avg", "station_Name", "Alt", "Type", "daily_avg"))
...
mytext=paste("Station: ", map_data$station_Name, "<br/>", "Value: ", round(map_data$daily_avg, 1), "<br/>", "Temperature: ", map_data$temp_avg, "<br/>", "Altitude: ", map_data$Alt, "<br/>", "Station Type: ", map_data$Type, sep="") %>%
...
leaflet(map_data) %>%  
  ...
  addLegend( pal=mypalette, values=~daily_avg, opacity=0.9, title = "microg/m^3", position = "bottomright" )
